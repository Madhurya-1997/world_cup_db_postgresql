...
DROP DATABASE world_cup_db;
--
-- Name: world_cup_db; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE world_cup_db WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'English_India.1252';


ALTER DATABASE world_cup_db OWNER TO postgres;

\connect world_cup_db
...
--
-- Name: DATABASE world_cup_db; Type: COMMENT; Schema: -; Owner: postgres
--

COMMENT ON DATABASE world_cup_db IS 'database for world cup matches';
